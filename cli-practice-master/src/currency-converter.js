...
var amount = process.argv[2];  //this contains ist input
var initialCurrency = process.argv[3]; //this contains 2nd input
var targetCurrency = process.argv[4]; // this contains 3rd input
...
if (rates[initialCurrency] == undefined) {
        console.log('Whoops, initial is invalid.', initialCurrency);
process.exit();
}
...
console.log(`Successfully converted ${amount} ${initialCurrency} into ${
